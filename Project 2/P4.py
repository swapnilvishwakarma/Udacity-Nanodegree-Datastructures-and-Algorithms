...
def is_user_in_group(user, group):
    ...
    for j in group.get_groups():
        output |= is_user_in_group(user, j)
    return output
...
print("Pass" if (is_user_in_group(parent_user_1, parent) is True) else "Fail")

# Parent2 in Parent
print("Pass" if (is_user_in_group(parent_user_2, parent) is True) else "Fail")

# Child1_1 in Parent
print("Pass" if (is_user_in_group(child1_user_1, parent) is True) else "Fail")

# Child1_2 in Parent
print("Pass" if (is_user_in_group(child1_user_2, parent) is True) else "Fail")

# Child2_1 in Parent
print("Pass" if (is_user_in_group(child2_user_1, parent) is True) else "Fail")

# Child2_2 in Parent
print("Pass" if (is_user_in_group(child2_user_2, parent) is True) else "Fail")

# SubChild11_1 in Parent
print("Pass" if (is_user_in_group(sub_child11_user_1, parent) is True) else "Fail")

# SubChild11_2 in Parent
print("Pass" if (is_user_in_group(sub_child11_user_2, parent) is True) else "Fail")

# SubChild22_1 in Parent
print("Pass" if (is_user_in_group(sub_child21_user_1, parent) is True) else "Fail")

# SubChild22_2 in Parent
print("Pass" if (is_user_in_group(sub_child21_user_2, parent) is True) else "Fail")

# Subchild22_2 in Child1
print("Pass" if (is_user_in_group(sub_child22_user_2, child1) is False) else "Fail")

# Subchild11_1 in Child2
print("Pass" if (is_user_in_group(sub_child11_user_1, child2) is False) else "Fail")